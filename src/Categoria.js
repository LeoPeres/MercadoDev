...
class Categoria extends Component{
    ...
    loadAnuncios(urlCategoria){
        ...
        const url = `https://mercadodev-3d791.firebaseio.com/anuncios.json?orderBy=%22categoria%22&equalTo=%22${urlCategoria}%22`
            ...
            <div>
                ...
                <div className='row'>
                    {Object.keys(this.state.anuncios).map(key => {
                        ...
                        return <AnuncioHome anuncio={anuncio} key={key} id={key} />
                    })}
                </div>
            </div>
